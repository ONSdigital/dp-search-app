...
content_types = [home_page, home_page_census, taxonomy_landing_page, product_page, bulletin,
                 article, article_download, timeseries, data_slice, compendium_landing_page,
                 compendium_chapter, compendium_data, static_landing_page, static_article,
                 static_methodology, static_methodology_download, static_page, static_qmi,
                 static_foi, static_adhoc, dataset, dataset_landing_page, timeseries_dataset,
                 release, reference_tables, chart, table, equation, departments]
